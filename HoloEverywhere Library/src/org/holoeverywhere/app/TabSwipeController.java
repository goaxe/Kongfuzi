...
public abstract class TabSwipeController implements TabSwipeInterface<TabInfo> {
    ...
    public final class TabSwipeAdapter extends FragmentStatePagerAdapter implements
            OnPageChangeListener, TabListener {
    	public Map<Integer, Fragment> fragments = new ConcurrentHashMap<Integer, Fragment>();
        ...
        public Fragment getItem(int position) {
            ...
            Fragment tmp = Fragment.instantiate(info.mFragmentClass, info.mFragmentArguments);
            fragments.put(position, tmp);
            return tmp;
        }
    ...
    public TabSwipeAdapter mAdapter;
    ...
    public TabSwipeAdapter getAdapter() {
    	return mAdapter;
    }
