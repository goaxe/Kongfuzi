...
public class HomeworkDateListActivity extends Activity {

  public static final String DEBUG_TAG = "HomeworkDateListActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_homework_date_list);
    mActivity = this;
    mCurrentDate = getIntent().getStringExtra(Constants.DATE);
    getSupportActionBar().setTitle(mCurrentDate + "作业汇总");
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      view.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
          Intent intent = new Intent(mActivity, HomeworkSubjectListActivity.class);
  ...
  public class RefreshDataThread extends Thread {
    ...
    public void run() {
      ...
      try {
        JSONObject jsonObject = client.zuoyeListBySubject(mCurrentDate, 0, 20);
        ...
        for (int i = 0; i < jsonArray.length(); i ++) {
          ...
          ListItem item = new ListItem(date, hwSubject, countAll, countWeijiao, countWeipi, countYipi);
  ...
  public class ListItem {
    ...
    public ListItem(String date, String hwSubject, Integer countAll, Integer countWeijiao, Integer countWeipi,
        Integer countYipi) {
      this.date = date;
