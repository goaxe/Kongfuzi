...
public class ZuoyeStudentListActivity extends Activity {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      view.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
          // TODO Auto-generated method stub
          Intent intent = new Intent(getApplicationContext(), ZuoyeSubmitActivity.class);
          ...
          intent.putExtra(Constants.STUDENT_NAME, item.name);
          intent.putExtra(Constants.HW_LIST_ID, item.hwListId);
  ...
  public class RefreshDataThread extends Thread {
    ...
    public void run() {
      ...
      try {
        JSONObject jsonObject = client.zuoyeStudentList(mCurrentClassId, mCurrentDate, mCurrentTitle, mCurrentSubject);
        String hwListId = jsonObject.getString("hwlistid");
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
          ...
          ListItem item = new ListItem(hwListId, name, number, orgStudentId, sex, email, phone, age, picId, idCard, finished);
  ...
  public class ListItem {
    ...
    public ListItem(String hwListId, String name, String number, String orgStudentId, String sex, String email, String phone,
