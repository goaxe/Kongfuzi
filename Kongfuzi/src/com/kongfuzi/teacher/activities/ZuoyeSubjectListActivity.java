...
public class ZuoyeSubjectListActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    getSupportActionBar().setTitle("录入作业成绩");
    setContentView(R.layout.activity_zuoye_subject_list);
    mActivity = this;
  ...
  public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      view.setOnClickListener(new OnClickListener() {
        ...
        @Override
        public void onClick(View v) {
          Intent intent = new Intent(mActivity, ZuoyeStudentListActivity.class);
