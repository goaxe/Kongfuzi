...
public class XuanDaxueByProvinceActivity extends Activity {

  public static final String DEBUG_TAG = "XuanDaxueByProvinceActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_xuan_daxue_by_province);
    mActivity = this;
