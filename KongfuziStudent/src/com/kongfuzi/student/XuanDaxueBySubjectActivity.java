...
public class XuanDaxueBySubjectActivity extends Activity {
  
  public static final String DEBUG_TAG = "XuanDaxueBySubjectActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_xuan_daxue_by_subject);
    mActivity = this;
