...
public class XuanDaxueListActivity extends Activity {
  public static final String DEBUG_TAG = "XuanDaxueListActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_xuan_daxue_list);
  ...
  public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      View view = getLayoutInflater().inflate(R.layout.xuan_daxue_list_item_layout);
